...
public class Linha extends Figura
{
    ...
    public Linha (int x1, int y1, int x2, int y2, Color cor, Color corFundo)
    {
		this.corFundo = corFundo;
		this.cor = cor;
        this.p1 = new Ponto (x1,y1,cor,corFundo);
        this.p2 = new Ponto (x2,y2,cor,corFundo);
    }
    ...
    {
        this.p1 = new Ponto (x,y,this.getCor(),this.getCorFundo());
    }

    public void setP2 (int x, int y)
    {
        this.p2 = new Ponto (x,y,this.getCor(),this.getCorFundo());
    }
